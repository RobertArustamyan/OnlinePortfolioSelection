...
def analyze_training_effect(base_dir, look_for_name):
    """
    ...
    for folder in base_path.iterdir():
        ...
        json_path = folder / f'{look_for_name}.json'
...
if __name__ == '__main__':
    results_dir = r'C:\Users\rarustamyan\PycharmProjects\UniversalPortfolios\results\portfolio\WithCosts\BARRONS\TrainingTimeAnalysis'

    look_for_name_barrons = 'barrons_costs_detailed_results'
    # look_for_name_ons = 'ons_costs_detailed_results'

    df = analyze_training_effect(results_dir, look_for_name_barrons)
