...
def run_all_experiments(stocks, train_days=700, test_days=350, cost_models=None,
    ...
    if save_results:
        ...
        base_dir = Path(r'C:\Users\rarustamyan\PycharmProjects\UniversalPortfolios\results\portfolio\WithCosts\ONS\TrainingTimeAnalysis')
...
if __name__ == '__main__':
    # Configuration
    STOCKS = ["GOOGL", "AMC", "NVDA", "AAPL"] # Fixed stocks for testing training day effect
    TEST_DAYS = 365 * 3
    SAVE_RESULTS = True
    N_JOBS = 16
    ...
    ib_params = {
        ...
        'improvement_thresholds': [0.0, 0.02]
    }
